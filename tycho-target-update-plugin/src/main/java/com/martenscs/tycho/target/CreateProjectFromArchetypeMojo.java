...
public class CreateProjectFromArchetypeMojo extends AbstractMojo implements ContextEnabled {
    ...
    /**
     * The archetype catalogs to use to build a list and let the user choose from. It is a comma
     * separated list of catalogs. Catalogs use following schemes:
     * <ul>
     * <li>'<code>file://...</code>' with <code>archetype-catalog.xml</code> automatically appended
     * when pointing to a directory</li>
     ...
     * <li>'<code>remote</code>' which is the shortcut for Maven Central repository, ie '
     * <code>http://repo1.maven.org/maven2</code>'</li>
     * <li>'<code>internal</code>' which is an internal catalog</li>
     * </ul>
     * 
     * Since 2.0-alpha-5, default value is no longer <code>internal,local</code> but
     * <code>remote,local</code>. If Maven Central repository catalog file is empty,
    ...
    /**
     * Applying some filter on displayed archetypes list: format is <code>artifactId</code> or
     * <code>groupId:artifactId</code>.
     * <ul>
     * <li><code>org.apache:</code> -> displays all archetypes which contain org.apache in groupId</li>
     * <li><code>:jee</code> or <code>jee</code> -> displays all archetypes which contain jee in
     * artifactId</li>
     * <li><code>org.apache:jee</code> -> displays all archetypes which contain org.apache in
     * groupId AND jee in artifactId</li>
     * </ul>
     * 
    ...
    public void execute() throws MojoExecutionException, MojoFailureException {
        ...
        ArchetypeGenerationRequest request = new ArchetypeGenerationRequest().setArchetypeGroupId(archetypeGroupId)
                ...
                .setArchetypeRepository(archetypeRepository).setRemoteArtifactRepositories(remoteArtifactRepositories)
                .setFilter(filter);
